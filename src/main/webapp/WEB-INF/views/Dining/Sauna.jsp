...
<div id="dinning_all_base">
	<div id="dinning_base">
		...
		<div id="slide_base">
			<div id="gallery">
				<div id="img_list">
					<img src="<c:url value='resources/images/Dining/sauna06.jpg' /> " width="700" height="360" />
					<img src="<c:url value='resources/images/Dining/sauna07.jpg' /> " width="700" height="360" />
					<img src="<c:url value='resources/images/Dining/sauna08.jpg' /> " width="700" height="360" />
				</div>			 
			</div>
			<div id="remote">
		...
		<div id="bottom_div">
					<div class="fit_title">Sauna</div>					
					<div class="fit_content">
						<div style="border-bottom:1px dotted black;height:65px;'">
							<div class="fit_content_title" style="height:65px;">◎&nbsp; 소개</div>
							<div class="fit_content_content">
								사우나는 365일 연중무휴로 24시간 운영되고 있어 고객님의 피로를 말끔히 풀어 드릴 것입니다. 
								또한 미용실과 이발소도 함께 이용하실 수 있습니다.
							</div>
						</div>
