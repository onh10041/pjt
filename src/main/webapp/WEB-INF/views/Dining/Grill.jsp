...
<div id="dinning_all_base">
	<div id="dinning_base">
		...
		<div id="slide_base">
			<div id="gallery">
				<div id="img_list">
					<img src="<c:url value='resources/images/Dining/grill12.jpg' /> " width="700" height="360" />
					<img src="<c:url value='resources/images/Dining/grill13.jpg' /> " width="700" height="360" />
					<img src="<c:url value='resources/images/Dining/grill16.jpg' /> " width="700" height="360" />
					<img src="<c:url value='resources/images/Dining/grill17.jpg' /> " width="700" height="360" />
				</div>			 
			</div>
			<div id="remote">
		...
		<div id="bottom_div">
					<div class="fit_title">Restaurant</div>					
					<div class="fit_content">
						<div style="border-bottom:1px dotted black;height:90px;'">
							<div class="fit_content_title" style="height:65px;">◎&nbsp; 소개</div>
							<div class="fit_content_content">
								투숙객을 위한 조식 서비스부터 간단한 티타임을 가질 수 있는 편안한 공간을 제공하고 있으며, 저녁시간엔 사랑하는 연인 또는 가족과 함께
								맛있는 식사를 즐기실 수 있는 공간입니다. 또한 각종 행사나 회의를 진행할 수 있는 시설도 마련되어 있어 손님들이 편하게 이용 하실 수 있습니다.
							</div>
						</div>
						<div style="border-bottom:1px dotted black;height:55px;margin-top:10px;">
							<div class="fit_content_title" style="height:55px;">◎&nbsp; 영업시간</div>
							<div class="fit_content_content"> 
								주중 07:30 ~ 23:30<br>
								주말/공휴일 7:30 ~ 22:00
							</div>
