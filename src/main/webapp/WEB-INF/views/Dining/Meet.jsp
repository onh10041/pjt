...
$(function(){	
	$('#remote div').click(function(){
		...
		$(s1).addClass('re_sel');
		$('#img_list').animate({left:(-1)*k*706}, 1000);
...
#remote{position:relative;width:110px;height:20px;float:right;margin-top:5px;}	
...
<div id="dinning_all_base">
	<div id="dinning_base">
		...
		<div id="slide_base">
			<div id="gallery">
				<div id="img_list">
					<img src="<c:url value='resources/images/Dining/meeting1.jpg' /> " width="700" height="360" />
					<img src="<c:url value='resources/images/Dining/meeting2.jpg' /> " width="700" height="360" />
				</div>			 
			</div>
			<div id="remote">
		...
		<div id="bottom_div">
					<div class="fit_title">Business Meeting Room</div>					
					<div class="fit_content">
						<div style="border-bottom:1px dotted black;height:60px;'">
							...
							<div class="fit_content_content">
								빔 프로젝터 및 매립식 자동스크린 화이트보드 등을 갖추고 있어 20인 이하의 소규모 모임 및 비즈니스 미팅 등에
								 최적화된 공간으로 이용하실 수 있습니다.
							</div>
						</div>
