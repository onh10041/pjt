...
<div id="dinning_all_base">
	<div id="dinning_base">
		...
		<div id="slide_base">
			<div id="gallery">
				<div id="img_list">
					<img src="<c:url value='resources/images/Dining/fit_06.jpg' /> " width="700" height="360" />
					<img src="<c:url value='resources/images/Dining/fit_07.jpg' /> " width="700" height="360" />
					<img src="<c:url value='resources/images/Dining/fit_08.jpg' /> " width="700" height="360" />
					<img src="<c:url value='resources/images/Dining/fit_09.jpg' /> " width="700" height="360" />
				</div>			 
			</div>
			<div id="remote">
		...
		<div id="bottom_div">
					<div class="fit_title">Fitness Center</div>					
					<div class="fit_content">
						<div style="border-bottom:1px dotted black;height:60px;'">
							<div class="fit_content_title" style="height:60px;">◎&nbsp; 소개</div>
							<div class="fit_content_content">
								최신식 러닝머신 15대와 30가지의 운동기구를 갖춘 해밀톤호텔 휘트니스는 사우나와 바로
								연결되어 있어 편리하게 이용하실 수 있습니다.
							</div>
						</div>
