...
#Room_context{position:relative; width:800px; height:920px;float:right;}   
	...
	<div id="Room_context_base">
		...
		<div id="Room_context" >
			<div id="Room_context_img">
				<img src="<c:url value='resources/images/Room/business_double.jpg' /> "/>			
			</div>
			<div id="Room_context_text">
				<h3>Business Double</h3>
				컴팩트한 구조를 가진 비즈니스 더블 룸은 아늑하고 넉넉한 여유 공간으로 내 집과 같은 편안함을 느낄 수 있도록 장기투숙을 
				원하는 비즈니스맨에게 추천하는 객실입니다. 바쁜 비즈니스맨의 모든 니즈와 편리함이 만족되는 최신설비와 최상의 서비스를 
				통해 편안한 휴식을 제공해 드립니다.
			</div>
				...
				<div id="Room_context_request">
					<div style="position:relative;top:10px;">
						...
						<div id="Room_context_icons">
							<img src="<c:url value='resources/images/Room/room_icon2.png' /> "/>
						</div>
					</div>
				</div>
			</div>
